function varargout = testuni(varargin)

% TESTUNI M-file for testuni.fig
...
%      applied to the GUI before testuni_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to testuni_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help testuni

% Last Modified by GUIDE v2.5 28-May-2017 05:14:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @testuni_OpeningFcn, ...
                   'gui_OutputFcn',  @testuni_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before testuni is made visible.
function testuni_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to testuni (see VARARGIN)

% Choose default command line output for testuni
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes testuni wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = testuni_OutputFcn(hObject, eventdata, handles) 
...
global  a1 b1 r1 h1 a2 b2 r2 h2 slope st2 st1
...
% cone & the left side of the cylinder
%uu=1/slope.*((x3-a2)-b2-h2)

% intersection bet cone side and cylinder y point
%inn=slope.*(a2-a1+r1)+h2+b2;


l=1; % for array x&y or s&n
 for i=maxb:0.2:maxh
     % solve cone side and center line to get radius  x co-ordinate
